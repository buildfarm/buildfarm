...
| reportResultStageWidth            | Integer, _1_                  |                       | Number of concurrently available slots to write results and clean up execution directories (0 = system calculated based on CPU cores)                                                                                                                                                                                    |
