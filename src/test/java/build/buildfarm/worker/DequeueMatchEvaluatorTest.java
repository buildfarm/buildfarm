...
public class DequeueMatchEvaluatorTest {
  ...
  public void shouldKeepOperationKeepEmptyQueueEntry() throws Exception {
    ...
    // ACT
    boolean shouldKeep =
        DequeueMatchEvaluator.shouldKeepOperation(workerProvisions, "worker-name", resourceSet, entry);
  ...
  public void shouldKeepOperationUnmatchedPropertiesRejectionAcceptance() throws Exception {
    ...
    // ACT
    shouldKeep = DequeueMatchEvaluator.shouldKeepOperation(workerProvisions, "worker-name", resourceSet, entry);
