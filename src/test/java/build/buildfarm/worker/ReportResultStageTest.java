  ...
  public void execDirDestroyedAfterComplete() throws Exception {
    ...
    OperationContext reportedContext =
        OperationContext.newBuilder()
            ...
            .build();
    when(context.putOperation(
            any(Operation.class),
            any(PlatformValidationSettings.class),
    ...
    verify(context, times(1))
        .putOperation(operationCaptor.capture(), eq(settings), eq(reportedContext.action));
