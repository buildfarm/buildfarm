...
public class AtomicFileWriterTest {
  ...
  public void successCreatesTarget() throws IOException {
    ...
    try (AtomicFileWriter writer = new AtomicFileWriter(target, fileStoreMover)) {
  ...
  public void hardLinkMoverSuccessCleansUpTempFile() throws IOException {
    ...
    try (AtomicFileWriter writer = new AtomicFileWriter(target, FileStoreMover.hardLinkMover())) {
      writer.write("test content");
      writer.onSuccess();
    }
  ...
  public void createsUniqueTempFiles() throws IOException {
    ...
    AtomicFileWriter writer1 = new AtomicFileWriter(target, fileStoreMover);
    AtomicFileWriter writer2 = new AtomicFileWriter(target, fileStoreMover);
  ...
  public void closeIsIdempotent() throws IOException {
    ...
    AtomicFileWriter writer = new AtomicFileWriter(target, fileStoreMover);
    writer.write("test content");
    writer.onSuccess();
    writer.close();
