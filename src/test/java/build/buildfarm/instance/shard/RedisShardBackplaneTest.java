...
public class RedisShardBackplaneTest {
  ...
  @Test
  public void withBackplaneExceptionEndOfStreamIsUnavailable()
    ...
    try {
      backplane.withVoidBackplaneException(
          (jedis) -> {
  ...
  @Test
  public void withBackplaneExceptionConnectionResetIsUnavailable()
      throws IOException, InterruptedException {
    when(mockJedisClusterFactory.get()).thenReturn(mock(JedisCluster.class));
    backplane =
        new RedisShardBackplane(
