...
public class ResourceLimits {
   ...
   * @details Prevent available cpu from being reduced beyond this amount
   * Must not be <= 0 for market interactions
   */
   ...
   * @details Headroom for per-sample volatility of use before its cpu may be sold
   * Must not be <= 0 for market interactions
   */
   ...
   * @details Headroom for per-sample volatility of throttle before cpu may be bought
   * Must not be <= 0 for market interactions
   */
   ...
   * @details Control the sale rate of unused shares
   * Must not be <= 0 for market interactions
   */
