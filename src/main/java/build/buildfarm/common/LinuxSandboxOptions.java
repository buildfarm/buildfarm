 ...
 *  @brief   These options correlate to the CLI arguments that need passed to
 *           bazel's linux sandbox.
 *  @details This data structure is intended to match bazel's linux sandbox
 *           options. See the following permalink this was implemented off of:
