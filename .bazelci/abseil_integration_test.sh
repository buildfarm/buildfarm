...
docker run --network host --env TEST_SHARD=$TEST_SHARD buildfarm buildfarm/.bazelci/test_buildfarm_container.sh buildfarm/.bazelci/run_generative_cc_many_test.sh